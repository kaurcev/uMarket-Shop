    ...
    return (
      <>
       ...
       <h1>Политика конфиденциальности персональных данных</h1>
        ...
        отношении всей информации, которую сайт <strong>Маркетплейс "юМаркет Шоп"</strong>, (далее – юМаркет Шоп) расположенный на 
        доменном имени <strong>umarketshop.site</strong> (а также его субдоменах), может получить о Пользователе во время использования 
        сайта umarketshop.site (а также его субдоменов), его программ и его продуктов.</p>
        ...
        на управление сайтом <strong>Маркетплейс "юМаркет Шоп"</strong>,
        ...
        <p>1.1.5. «Сайт <strong> Маркетплейс "юМаркет Шоп"</strong>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному 
        адресу (URL): <strong>umarketshop.site</strong>, а также его субдоменах.</p>

        <p>1.1.6. «Субдомены»  - это страницы или совокупность страниц, расположенные на доменах третьего уровня, 
        принадлежащие сайту Маркетплейс "юМаркет Шоп", а также другие временные страницы, внизу который указана контактная
        информация Администрации</p>
        
        <p>1.1.5. «Пользователь сайта <strong>Маркетплейс "юМаркет Шоп"</strong> » (далее Пользователь) – лицо, имеющее доступ 
        к сайту <strong>Маркетплейс "юМаркет Шоп"</strong>, посредством сети Интернет 
        и использующее информацию, материалы и продукты сайта <strong>Маркетплейс "юМаркет Шоп"</strong>.</p>
        ...
        <p>2.1. Использование сайта Маркетплейс "юМаркет Шоп" Пользователем означает согласие с настоящей Политикой 
        ...
        сайта Маркетплейс "юМаркет Шоп" .</p>

        <p>2.3. Настоящая Политика конфиденциальности применяется к сайту Маркетплейс "юМаркет Шоп".
        юМаркет Шоп не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь 
        может перейти по ссылкам, доступным на сайте Маркетплейс "юМаркет Шоп".</p>
        ...
        регистрации на сайте Маркетплейс "юМаркет Шоп" или при подписке на информационную e-mail рассылку.</p>
        
        <p>3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются 
        Пользователем путём заполнения форм на сайте Маркетплейс "юМаркет Шоп" и включают в себя следующую информацию:<br/>
        ...
        <p>3.3. юМаркет Шоп защищает Данные, которые автоматически передаются при посещении страниц:<br/>
        - IP адрес;<br/>
        ...
        <p>3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта Маркетплейс юМаркет Шоп, требующим 
        авторизации.</p>

        <p>3.3.2. юМаркет Шоп осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация 
        ...
        4.1.1. Идентификации Пользователя, зарегистрированного на сайте Маркетплейс "юМаркет Шоп" для его дальнейшей авторизации.<br/>

        4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта Маркетплейс "юМаркет Шоп".<br/>

        4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся использования 
        сайта Маркетплейс "юМаркет Шоп", обработки запросов и заявок от Пользователя.<br/>

        4.1.4. Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.<br/>

        4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br/>

        4.1.6. Создания учетной записи для использования частей сайта Маркетплейс "юМаркет Шоп", если Пользователь дал согласие на 
        ...
        сайта Маркетплейс "юМаркет Шоп".<br/>
        ...
        сайта Маркетплейс "юМаркет Шоп", и давать согласие на их обработку.</p>
        ...
        тексты и т. д.), к которой он может иметь доступ как к части сайта Маркетплейс "юМаркет Шоп", несет лицо, предоставившее 
        такую информацию.</p>
        
        <p>7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта Маркетплейс "юМаркет Шоп", может 
        являться объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям, 
        партнерам или рекламодателям, которые размещают такую информацию на сайте Маркетплейс "юМаркет Шоп". <br/>
        ...
        сайте Маркетплейс "юМаркет Шоп") допускается их распространение при условии, что будет дана ссылка 
        на юМаркет Шоп.</p>
        ...
        содержащихся на сайте Маркетплейс "юМаркет Шоп" или передаваемых через него.</p>
        ...
        сайте Маркетплейс "юМаркет Шоп", включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого 
        ...
        <p>8.3. При не достижении соглашения спор будет передан на рассмотрение Арбитражного суда г. Омск.</p>
        ...
        <p>9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте Маркетплейс "юМаркет Шоп", если 
        ...
        адресу: info@umarketshop.site</p>
        
        <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу https://umarketshop.site/privacy</p>

        <p>Обновлено: 04 Марта 2024 года</p>
        <p>г. Омск, Александр Каурцев</p>
       </main>
       <Footer />
      </>
    )
